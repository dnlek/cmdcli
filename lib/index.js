...
var GLOBAL_CONFIG_FILE = os.homedir() + '/' + CONFIG_FILE;
...
var config = Promise.all([(0, _utils.getConfig)(GLOBAL_CONFIG_FILE), (0, _utils.getConfig)(CONFIG_FILE)]).then(function (result) {
  return args.global ? _extends({}, BASE_CONFIG, result[1]) : _extends({}, BASE_CONFIG, result[1], result[2]);
});
